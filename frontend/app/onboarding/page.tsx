...
export default function OnboardingPage() {
  ...
  const completeness = getOnboardingCompletenessPreview(formData);
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="mb-8">
              ...
              <p className="text-slate-500 text-sm">This information helps us match you with relevant GeM tenders and pre-fill your proposals.</p>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setFormData((prev) => ({ ...prev, years_in_operation: e.target.value }))}
                        className="w-full px-3 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-slate-700"
                      >
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm sticky top-24">
              ...
              <div className="space-y-2.5 mt-4">
                {[
                  ...
                  {
                    label: 'Udyam uploaded',
                    done: formData.docs.udyam?.status === 'uploaded',
                  },
                  {
                    label: 'GST uploaded',
                    done: formData.docs.gst?.status === 'uploaded',
                  },
                ].map((item) => (
